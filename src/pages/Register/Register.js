            ...
            <div className="card-body row p-0">
                <div className="col-lg-6">
                    <div className="form-content p-5 h-100 d-flex align-items-center justify-content-center flex-column bg-diagonal-gradient-primary-2 radius-top-left-8 radius-bottom-left-8 text-left">
                        <h3 className="fs-35 pb-4 fw-bold text-white w-100">Join the Disilab Community</h3>
                ...
                <div className="col-lg-5 mx-auto">
                    <div className="form-action-wrapper py-5">
                        <div className="form-group">
                            <h3 className="fs-22 pb-3 fw-bold">Sign up to Disilab</h3>
                            <div className="divider"><span></span></div>
                        </div>
                        <div className="form-group">
                            <label className="fs-14 text-black fw-medium lh-18">Display name</label>
                            <input type="email" name="email" className="form-control form--control" placeholder="Enter name" />
                        </div>
                        {/* <!-- end form-group --> */}
                        <div className="form-group">
                            <label className="fs-14 text-black fw-medium lh-18">Email</label>
                            <input type="email" name="email" className="form-control form--control" placeholder="Email address"/>
                        </div>
                        {/* <!-- end form-group --> */}
                        <div className="form-group">
                            <label className="fs-14 text-black fw-medium lh-18">Password</label>
                            <div className="input-group mb-1">
                                <input className="form-control form--control password-field" type="password" name="password" placeholder="Password"/>
                        ...
                        <div className="form-group">
                            <div className="d-flex align-items-center">
                                <div className="custom-control custom-checkbox fs-13 mr-4">
                                    <input type="checkbox" className="custom-control-input" id="opt-in"/>
                                    <label className="custom-control-label custom--control-label lh-18" for="opt-in">Opt-in to receive occasional product updates, user research invitations, company announcements, and digests.</label>
                                </div>
                                ...
                                <path d="M7 1a6 6 0 1 0 0 12A6 6 0 0 0 7 1zm1.06 9.06c-.02.63-.48 1.02-1.1 1-.57-.02-1.03-.43-1.01-1.06.02-.63.5-1.04 1.08-1.02.6.02 1.05.45 1.03 1.08zm.73-3.07-.47.3c-.2.15-.36.36-.44.6a3.6 3.6 0 0 0-.08.65c0 .04-.03.14-.16.14h-1.4c-.14 0-.16-.09-.16-.13-.01-.5.11-.99.36-1.42A4.6 4.6 0 0 1 7.7 6.07c.15-.1.21-.21.3-.33a1.14 1.14 0 0 0 .02-1.48c-.22-.26-.46-.4-.92-.4-.45 0-.83.23-1.02.52-.19.3-.16.63-.16.94H4.2c0-1.17.31-1.92.98-2.36a3.5 3.5 0 0 1 1.83-.44c.88 0 1.58.16 2.2.62.58.42.88 1.02.88 1.82 0 .5-.17.9-.43 1.24-.15.2-.44.47-.86.79h-.01z" />
                            </svg>
                                </button>
                                <div className="generic-popover d-none">
                                    <p className="pb-2 fs-14">We know you hate spam, and we do too. That’s why we make it easy for you to update your email preferences or unsubscribe at anytime.</p>
                                    <p className="fs-14">We never share your email address with third parties for marketing purposes.</p>
                                </div>
                                {/* <!-- end generic-popover --> */}
                            </div>
                        </div>
                        ...
                        {/* <!-- end form-group --> */}
                        <p className="fs-13 lh-18 pb-3">By clicking “Sign up”, you agree to our <Link to="terms-and-conditions.html" className="text-color hover-underline">terms of conditions</Link>, <Link to="privacy-policy.html" className="text-color hover-underline">privacy policy</Link></p>
                        <div className="social-icon-box">
                            <div className="pb-3 d-flex align-items-center">
                                <hr className="flex-grow-1 border-top-gray"/><span className="mx-2 text-gray-2 fw-medium text-uppercase fs-14">or</span><hr className="flex-grow-1 border-top-gray"/>
                            </div>
                            <button className="btn theme-btn google-btn d-flex align-items-center justify-content-center w-100 mb-2" type="button">
                                <span className="btn-icon"><svg focusable="false" width="16px" height="16px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg></span>

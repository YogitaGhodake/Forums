                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="hero-content">
                                <h3 className="fs-16 fw-medium pb-3">Who we are</h3>
                                <h2 className="section-title fs-40 pb-3 lh-55">Helping developers and technologists write the script of the future.</h2>
                                <p className="lh-26 pb-3">Our public platform <strong className="fw-medium text-black">serves 100 million people every month</strong>, making it one of the 50 most popular websites in the world.</p>
                                <p className="lh-26">Our asynchronous knowledge management and collaboration offering <strong className="fw-medium text-black">Nova Forums for Teams</strong>, is transforming how people work.</p>
                            </div>{/* end hero-content */}
                        </div>{/* end col-lg-6 */}
                        <div className="col-lg-6">
                            <div className="generic-img-box h-100">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item hover-y text-center award-card">
                                            <Link to="#" class="card-body">
                                                <svg className="mb-3" width={50} height={55} fill="none">
                                                    <path d="m21.795 46 21.569-12.025V.57H0v33.181L21.795 46z" fill="#F74222" />
                                                    <path
                                                        d="M24.52 10.479c-.909-.223-1.817-.223-2.725-.223H20.66c-7.265.223-12.714 6.236-12.487 13.362.227 7.126 6.357 12.47 13.622 12.247 2.952 0 5.676-.89 7.946-2.45l-2.95-4.898a8.029 8.029 0 0 1-4.996 1.781h-.908c-4.087-.222-7.265-3.785-7.038-7.794.227-4.008 3.86-7.126 7.946-6.903l2.725-5.122z"
                                                        fill="#fff"
                                                    />
                                                    <path
                                                        d="m34.51 26.735-3.406-5.567h-6.357l-3.406 5.567h6.584l3.179 5.345 3.405-5.345zm-8.174-10.02c-.454.667-.681 1.558-.681 2.449l6.13.223v-1.56h-4.087c.227-.667.681-.89 1.362-1.335l.681-.446c1.363-.445 2.044-1.336 2.044-2.45 0-.667-.454-1.335-.908-1.78-.454-.446-1.363-.669-2.044-.669-.68 0-1.362 0-2.043.445-.454.446-.908.891-1.135 1.336l1.135 1.114c.454-.89 1.135-1.336 2.043-1.336.455 0 1.136.445 1.136.89 0 .446-.228.669-1.136 1.114l-.454.223c-.68.445-1.589 1.113-2.043 1.781z"
                                                        fill="#fff"
                                                    />
                                                </svg>
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="card card-item hover-y text-center award-card">
                                            <Link to="#" class="card-body">
                                                ...
                                                <p class="lh-24">Forums for Teams won the <span class="fw-medium">2020 Stratus Award for Cloud Collaboration</span></p>
                                            </Link>
                                        </div>
                                        {/* <!-- end card --> */}
                                    </div>
                                    ...
                                    <div class="col-lg-10 mx-auto">
                                        <div class="award-content text-center">
                                            <p class="section-desc pb-3">Founded in 2009, Forums’s public platform is used by nearly everyone who codes to learn, share their knowledge, collaborate, and build their careers. Our products and tools help developers and technologists in life and at work. These products include
                                                <Link to="#" class="text-color hover-underline">Forums for Teams</Link>, <Link to="#" class="text-color hover-underline">Forums Advertising</Link>, and Forums for
                                                <Link to="#" class="text-color hover-underline">Talent</Link> and <Link to="#" class="text-color hover-underline">Jobs</Link>.</p>
                                            <p class="section-desc pb-3">Forums for Teams, our core SaaS collaboration product, is helping thousands of companies around the world as the transition to remote work, address business continuity challenges, and undergo digital transformation.</p>
                                            <p class="section-desc pb-3">Whether it’s on Forums or within Forums for Teams, community is at the center of all that we do.</p>
                                        </div>
                                    </div>
                                </div>
                                {/* <!-- end row--> */}
                            ...
                            <div class="container">
                                <div class="about-box bg-white shadow-md rounded-rounded px-5 pt-40px pb-90px">
                                    <div class="about-content pb-90px text-center">
                                        ...
                                        <p class="section-desc pb-3">Forums mission is to share and grow the world’s knowledge. A vast amount of the knowledge that would be valuable to many people is currently only available to a few — either locked in people’s heads, or only accessible to select groups.</p>
                                    ...
                                    <div class="client-logo-box pb-60px">
                                        ...
                                        <div class="row justify-content-center text-center">
                                            <div class="client-logo-item col-lg-3 mb-2 responsive-column-half">
                                                <img src="assets/images/client-logo.png" alt="client-logo" class="filter-gray" />
                                            </div>
                                            {/* <!-- end client-logo-item --> */}
                                            <div class="client-logo-item col-lg-3 mb-2 responsive-column-half">
                                                <img src="assets/images/client-logo-2.png" alt="client-logo" class="filter-gray" />
                                            </div>
                                            {/* <!-- end client-logo-item --> */}
                                            <div class="client-logo-item col-lg-3 mb-2 responsive-column-half">
                                                <img src="assets/images/client-logo-3.png" alt="client-logo" class="filter-gray" />
                                            </div>
                                            {/* <!-- end client-logo-item --> */}
                                            <div class="client-logo-item col-lg-3 mb-2 responsive-column-half">
                                                <img src="assets/images/client-logo-4.png" alt="client-logo" class="filter-gray" />
                                            </div>
                                            {/* <!-- end client-logo-item --> */}
                                            <div class="client-logo-item col-lg-3 mb-2 responsive-column-half">
                                                <img src="assets/images/client-logo-5.png" alt="client-logo" class="filter-gray" />
                                            </div>
                                            {/* <!-- end client-logo-item --> */}
                                            <div class="client-logo-item col-lg-3 mb-2 responsive-column-half">
                                                <img src="assets/images/client-logo-6.png" alt="client-logo" class="filter-gray" />
                                            </div>
                                            {/* <!-- end client-logo-item --> */}
                                        </div>
                                        {/* <!-- end row --> */}
                                                ...
                                                <div class="info-box px-3 text-center">
                                                    <div class="icon-element icon-element-lg mb-4 shadow-sm mx-auto">
                                                        <svg
                                                            ...
                                                            viewBox="0 0 168.107 168.106"
                                                            xmlSpace="preserve"
                                                        >
                                                            <path d="M143.543 14.515a47.445 47.445 0 0 0-22.952-5.91 47.309 47.309 0 0 0-36.515 17.201C75.336 15.3 62.219 8.605 47.478 8.605c-8.304 0-16.12 2.167-22.925 5.91C9.917 22.592 0 38.157 0 56.08c0 5.122.819 10.047 2.331 14.645 4.465 20.093 28.622 34.735 49.585 51.414 17.196 13.657 32.167 37.362 32.167 37.362s14.512-23.377 31.39-36.77c21.081-16.682 45.768-31.642 50.302-51.997a46.68 46.68 0 0 0 2.333-14.643c-.009-17.934-9.922-33.499-24.565-41.576zm9.422 52.006c-.461 1.445-1.774 2.299-3.185 2.299-.346 0-.724 0-1.05-.131a3.364 3.364 0 0 1-2.135-4.269 26.171 26.171 0 0 0 1.345-8.339 27.327 27.327 0 0 0-14.123-23.901c-4.1-2.298-8.531-3.414-13.227-3.414a3.35 3.35 0 0 1-3.354-3.35c0-1.907 1.485-3.352 3.354-3.352 5.845 0 11.393 1.379 16.477 4.271 10.84 5.909 17.57 17.335 17.57 29.745a32.804 32.804 0 0 1-1.672 10.441z" />
                                                        </svg>
                                                    </div>
                                                    <div class="info-body">
                                    ...
                                    <div class="client-logo-box pt-60px">
                                        ...
                                        <div class="row justify-content-center text-center pt-50px">
                                            <div class="col-lg-3 responsive-column-half">
                                                <Link to="#" class="client-logo-item mb-30px bg-white shadow-sm p-3 rounded-rounded d-block hover-y">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="career-content mb-50px">
                                            ...
                                            <div class="btn-box pb-3">
                                                <Link to="/careers" class="btn theme-btn mr-2 mb-2">Current job openings <i class="la la-arrow-right icon ml-1"></i></Link>
                                                <Link to="/contact" class="btn theme-btn theme-btn-outline theme-btn-outline-gray mb-2">Contact us <i class="la la-arrow-right icon ml-1"></i></Link>
                                            </div>
                                            <hr class="border-top-gray" />
                                            <div class="address-box d-flex pt-4">
                                                <img src="assets/images/img-loading.png" data-src="assets/images/illo-new-york.png" alt="Illustration of New York skyline" class="mr-4 img-fluid rounded-rounded lazy" />
                                                <div>
                                            ...
                                            <p class="fs-14 pt-4">* All employees are currently <Link to="#" class="btn-text">working fully remote <i class="la la-arrow-right icon ml-1"></i></Link></p>
                                        </div>
                                        {/* <!-- end career-content --> */}
                                    </div>
                                    {/* <!-- end col-lg-5 --> */}
                                    <div class="col-lg-7">
                                        <div class="work-content d-flex flex-wrap align-items-center justify-content-end">
                                            <div class="work-content-card d-flex align-items-center justify-content-center text-center bg-diagonal-gradient-primary js-tilt" data-toggle="tooltip" data-placement="top" title="37%">
                                                <div class="work-content-card-inner">
                                                    ...
                                                    >
                                                        ...
                                                        <path d="M1 5c0-1.1.9-2 2-2h6v5H1V5z" fill="#0B327C" />
                                                        <path
                                                            d="M17 5H9v1h8V5zm-2-2H9v1h7.73A2 2 0 0 0 15 3zm2 4H9v1h8V7zm0 2v1H1V9h16zm0 2v1H1v-1h16zm-.27 3a2 2 0 0 0 .27-.99V13H1c0 .36.1.7.27 1h15.46z"
                                                            fill="red"
                                                        />
                                                    </svg>
                                            ...
                                            <div class="work-content-card remote d-flex align-items-center justify-content-center text-center bg-diagonal-gradient-primary js-tilt" data-toggle="tooltip" data-placement="top" title="44%">
                                                <div class="work-content-card-inner">
                                                    <svg aria-hidden="true" class="mb-2" width="22" height="22" viewBox="0 0 18 18"><path d="M9 1a8 8 0 100 16A8 8 0 009 1zM8 15.32a6.4 6.4 0 01-5.23-7.75L7 11.68v.8c0 .88.12 1.32 1 1.32v1.52zm5.72-2c-.2-.66-1-1.32-1.72-1.32h-1v-2c0-.44-.56-1-1-1H6V7h1c.44 0 1-.56 1-1V5h2c.88 0 1.4-.72 1.4-1.6v-.33a6.4 6.4 0 012.32 10.24v.01z" fill="white"></path>
                                                    </svg>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="info-box px-3">
                                            ...
                                            <div class="info-body">
                                                ...
                                                <Link to="/faq" class="btn theme-btn theme-btn-sm">Visit Site <i class="la la-arrow-right icon ml-1"></i></Link>
                                            </div>
                                        </div>
                                        {/* <!-- end info-box --> */}
                                    </div>
                                    ...
                                    <div class="col-lg-4 responsive-column-half">
                                        <div class="info-box px-3">
                                            ...
                                            <div class="info-body">
                                                <h3 class="fs-18 pb-4 fw-bold">Looking for help with Forums for Teams?</h3>
                                                <Link to="/faq" class="btn theme-btn theme-btn-sm">Team help <i class="la la-arrow-right icon ml-1"></i></Link>
                                            </div>
                                        </div>
                                        {/* <!-- end info-box --> */}
                                    </div>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between">
                                                <div class="custom-control custom-checkbox fs-14">
                                                    ...
                                                    <label class="custom-control-label custom--control-label" htmlFor="rememberMe">Remember me!</label>
                                                </div>
                                                <Link to="#!void(0)" class="lost-pass-btn fs-14 hover-underline">Forgot Password?</Link>
                                            </div>
                                            <div class="btn-box">
                                            ...
                                            <p class="create-account-text text-right fs-14 pt-1">
                                                New to Forums?
                                                <Link class="signup-btn text-color hover-underline" to="#!void(0)">Create account</Link>
                                            </p>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox fs-14">
                                                    ...
                                                    <label class="custom-control-label custom--control-label" htmlFor="agreeCheckBox">By signing up, you agree to our
                                                        <Link to="#" class="text-color hover-underline">Privacy Policy.</Link></label>
                                                </div>
                                            </div>
                                            <div class="btn-box">
                                                <button type="submit" class="btn theme-btn w-100">
                                            ...
                                            <p class="create-account-text text-right fs-14">
                                                Already on Forums? <Link class="login-btn text-color hover-underline" to="#">Log in</Link>
                                            </p>
                                            <div class="icon-element my-4 mx-auto shadow-sm fs-25">Or</div>
                                            <div class="text-center">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="fs-15 lh-20 pb-3">
                                            ...
                                            <Link to="/contact" class="text-color hover-underline">contact us</Link> or
                                            <Link to="#" class="text-color hover-underline">send us an email</Link>
                                        </p>
                                        <form method="post">
                                            <div class="form-group">
                                                <label class="fs-14 text-black fw-medium lh-18">Email</label>
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <p class="create-account-text text-right fs-14">
                                                    Not a member?
                                                    <Link class="text-color signup-btn hover-underline" to="#!void(0)">Create account</Link>
                                                </p>
                                            </div>
                                        </form>
                                    </div>

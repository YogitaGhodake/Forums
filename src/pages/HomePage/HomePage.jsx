                            ...
                            <div className="col-lg-6 mr-auto">
                                <div className="hero-content">
                                    <h2 className="section-title fs-50 pb-3 text-white lh-65">
                                        The best FinTech Platform Development Community!
                                    </h2>
                                    <p className="lh-26 text-white">
                                        Exclusive community to discuss and share ideas related FinTech advancements, bought to you by Nova.
                                    </p>
                                    <div className="hero-btn-box pt-30px">
                                        <Link to="#fordevelopers" className="btn theme-btn mr-2 page-scroll">
                                            For Developers
                                            <i className="la la-angle-down icon ml-1"></i></Link>
                                        <Link to="#forbusinesses" className="btn theme-btn bg-3 page-scroll">
                                            For StartUps
                                            <i className="la la-angle-down icon ml-1"></i></Link>
                                    </div>
                                </div>
                ...
                <section className="client-logo-area section--padding bg-radial-gradient-gray">
                    <div className="container">
                        <div className="client-logo-box">
                            <h3 className="fs-21 text-center text-gray">
                                India's top FinTech StartUps use Nova Forums for their developments and support.
                ...
                <section className="get-started-area section--padding pattern-bg" id="fordevelopers">
                    <div className="container">
                        <div className="text-center">
                            ...
                            <p className="section-desc w-50 mx-auto">Nova Forums is an open community for anyone that codes to build the next big thing in trading and financial technology domain.
                                <br />
                                We help you get answers
                                to your toughest tech questions, and help you build the next unicorn.
                            </p>
                        </div>
                                ...
                                <div className="card card-item hover-y text-center">
                                    <div className="card-body">
                                        ...
                                        <p className="card-text pb-4">
                                            A community based space to find and contribute the answers to technical challenges for Nova based products.
                                        </p>
                            ...
                            <div className="col-lg-4 responsive-column-half">
                                <div className="card card-item hover-y text-center">
                                    <div className="card-body">
                                        ...
                                        <h5 className="card-title pt-4 pb-2">Multi-Platform</h5>
                                        <p className="card-text pb-4">
                                            Nova Forums provide support for major technologies like ASP.Net, PHP, React, Angular, Python, JavaScript, Java and many more.
                                        </p>
                                        <Link to="#" className="btn theme-btn bg-3">Try for free <i className="la la-arrow-right icon ml-1"></i></Link>
                                    </div>
                                    {/* <!-- end card-body --> */}
                                </div>
                                {/* <!-- end card --> */}
                            ...
                            <div className="col-lg-4 responsive-column-half">
                                <div className="card card-item hover-y text-center">
                                    <div className="card-body">
                                        ...
                                        <p className="card-text pb-4">
                                            Find the finest talent, well versed in trading and financial technology domain ready to help you develop cutting edge products.

                                        </p>
                                        <Link to="/careers" className="btn theme-btn">Find a job <i className="la la-arrow-right icon ml-1"></i></Link>
                                    </div>
                                    {/* <!-- end card-body --> */}
                                </div>
                                {/* <!-- end card --> */}
...
================================= --> */}
                <section className="get-started-area section--padding bg-gray" id="for-businesses">
                    <div className="container">
                        <div className="text-center">
                            <h2 className="section-title pb-3">For Enterprises and StartUps</h2>
                        ...
                        <div className="row pt-50px">
                            <div className="col-lg-4 responsive-column-half">
                                <div className="media media-card align-items-center hover-s">
                                    ...
                                    <div className="media-body">
                                        <h5 className="pb-2"><Link to="#">Public Q&A</Link></h5>
                                        <p>Quickly find and share technical knowledge with Public Q&A</p>
                                    </div>
                                </div>
                            </div>
                            {/* <!-- end col-lg-4 --> */}
                            <div className="col-lg-4 responsive-column-half">
                                <div className="media media-card align-items-center hover-s">
                                    ...
                                    <div className="media-body">
                                        <h5 className="pb-2"><Link to="#">Talent solutions</Link></h5>
                            ...
                            <div className="col-lg-4 responsive-column-half">
                                <div className="media media-card align-items-center hover-s">
                                    ...
                                    <div className="media-body">
                                        <h5 className="pb-2"><Link to="#">
                                            B2B
                                        </Link></h5>
                                        <p>
                                            All the support needed from design, development & market, at one place.
...
================================= --> */}
                <section className="info-area section--padding">
                    <div className="container">
                        <div className="text-center">
                            <h2 className="section-title lh-50 pb-35px">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                <br />
                                sed do eiusmod tempor incididunt ut labore et
                            </h2>
                            <Link to="#" className="btn theme-btn">Create a free team</Link>
                        </div>
...
================================= --> */}
                <section className="package-area section--padding bg-vertical-gradient-gray">
                    <div className="container">
                        <div className="text-center">
                            <h2 className="section-title pb-3">Unlock siloed knowledge with <br /> Nova Forums for Teams</h2>
                            ...
                            <div className="col-lg-5">
                                <div className="info-box text-center">
                                    ...
                                    <div className="info-body">
                                        ...
                                        <Link to="#" className="btn theme-btn">Forums Talent <i className="la la-arrow-right icon ml-1"></i></Link>
                                    </div>
                                </div>
                            </div>
                            {/* <!-- end col-lg-5 --> */}
                            ...
                            <div className="col-lg-5">
                                <div className="info-box text-center">
                                    ...
                                    <div className="info-body">
                                        ...
                                        <p className="pb-4">Contrary to popular belief, Lorem Ipsum is not simply random text. 
                                        It has roots in a piece of classical Latin literature from 45 BC
                                        </p>
                                        <Link to="#" className="btn theme-btn">Forums Advertising <i className="la la-arrow-right icon ml-1"></i></Link>
                                    </div>
                                </div>
                            </div>
                            {/* <!-- end col-lg-5 --> */}
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-5 text-right">
                                <Link to="#" className="btn theme-btn">Create Lonk free team <i className="la la-arrow-right icon ml-1"></i></Link>
                            </div>
                        </div>
                    </div>
                    {/* <!-- end container --> */}
                            ...
                            <div className="modal-body">
                                <form method="post">
                                    ...
                                    <p className="create-account-text text-right fs-14 pt-1">
                                        New to Forums? <Link className="signup-btn text-color hover-underline" to="#">Create account</Link>
                                    </p>
                                ...
                                <form method="post">
                                    ...
                                    <div className="form-group">
                                        <div className="custom-control custom-checkbox fs-14">
                                            ...
                                            <label className="custom-control-label custom--control-label" htmlFor="agreeCheckBox">By signing up, you agree to our <Link to="#" className="text-color hover-underline">Privacy Policy.</Link></label>
                                        </div>
                                    </div>
                                    <div className="btn-box">
                                        <button type="submit" className="btn theme-btn w-100">
                                    ...
                                    <p className="create-account-text text-right fs-14">
                                        Already on Forums? <Link className="login-btn text-color hover-underline" to="#">Log in</Link>
                                    </p>
                                    <div className="icon-element my-4 mx-auto shadow-sm fs-25">Or</div>
                                    <div className="text-center">
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p className="fs-15 lh-20 pb-3">
                                    ...
                                    resetting your password <Link to="/contact" className="text-color hover-underline">contact us</Link>
                                    or <Link to="#" className="text-color hover-underline">send us an email</Link>
                                </p>
                                <form method="post">
                                    <div className="form-group">
                                    ...
                                    <div className="btn-box">
                                        ...
                                        <p className="create-account-text text-right fs-14">
                                            Not a member? <Link className="text-color signup-btn hover-underline" to="#!">Create account</Link>
                                        </p>
                                    </div>
                                </form>
                            </div>

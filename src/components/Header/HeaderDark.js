...
const HeaderDark= ({auth: { isAuthenticated, loading, user }, logout}) => {
            ...
            <header className="header-area bg-dark">
                                        ...
                                        <form className="mr-4">
                                            <div className="form-group mb-0">
                                                ...
                                                maxLength='35'
                                                 ...
                                                 />
                                                <button 
                                                className="form-btn text-white-50"
                                                 type="button"
                        ...
                        <div className="off-canvas-menu custom-scrollbar-styled">
                            ...
                            <div className="off-canvas-btn-box px-4 pt-5 text-center">
                                <Link to="/login" className="btn theme-btn theme-btn-sm theme-btn-outline" data-toggle="modal" data-target="#loginModal"><i className="la la-sign-in mr-1"></i> Login</Link>
...
export default connect(mapStateToProps, { logout })(HeaderDark);

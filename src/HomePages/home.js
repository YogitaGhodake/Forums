                            ...
                            <div className="col-lg-10">
                                <div className="menu-wrapper">
                                    ...
                                    <div className="nav-right-button">
                                        <a href="#" className="btn theme-btn theme-btn-outline theme-btn-outline-white mr-2" data-toggle="modal" data-target="#loginModal"><i className="la la-sign-in mr-1"></i> Login</a>
                                        <a href="#" className="btn theme-btn theme-btn-white" data-toggle="modal" data-target="#signUpModal"><i className="la la-user mr-1"></i> Sign up</a>
                                    </div>   
            ...
            <div className="col-lg-6 responsive-column-half">
                <div className="media media-card align-items-center">
                    ...
                    <div className="media-body">
                        ...
                        <a href="home-2.html" className="btn theme-btn theme-btn-white">Browse questions <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
            </div>
            {/* <!-- end col-lg-6 --> */}
            ...
            <div className="col-lg-4 responsive-column-half">
                ...
                >
                    ...
                    <path d="M11 5h2v2h-2zM15 5h2v2h-2zM19 5h2v2h-2zM11 23h7v2h-7zM11 27h6v2h-6zM11 31h7v2h-7zM11 35h36v2H11zM45 39h2v2h-2zM11 39h32v2H11z" />
                        ...
                        <a href="home-2.html" className="btn theme-btn">Browse questions <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                    {/* <!-- end card-body --> */}
                </div>
                {/* <!-- end card --> */}
        ...
        <div className="row pt-50px">
            <div className="col-lg-4 responsive-column-half">
                ...
                >
                    ...
                    <div className="media-body">
                        <h5 className="pb-2"><a href="free-demo.html">Private Q&A</a></h5>
            ...
            <div className="col-lg-4 responsive-column-half">
                ...
                >
                    ...
                    <div className="media-body">
                        <h5 className="pb-2"><a href="talent.html">Talent solutions</a></h5>
            ...
            <div className="col-lg-4 responsive-column-half">
                ...
                >
                    ...
                    <div className="media-body">
                        <h5 className="pb-2"><a href="advertising.html">Advertising platform</a></h5>
...
<section className="info-area section--padding">
    <div className="container">
        <div className="text-center">
            ...
            <a href="free-demo.html" className="btn theme-btn">Create a free team</a>
        </div>
            ...
            <div className="col-lg-4 responsive-column-half">
                <div className="card card-item">
                    <div className="card-body">
                        ...
                        <a href="#" className="btn theme-btn theme-btn-outline w-100">Start your free trial <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
                {/* <!-- end card --> */}
            </div>
            ...
            <div className="col-lg-4 responsive-column-half">
                <div className="card card-item">
                    <div className="card-body">
                        ...
                        <a href="#" className="btn theme-btn w-100">Get started <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
                {/* <!-- end card --> */}
            </div>
            ...
            <div className="col-lg-4 responsive-column-half">
                <div className="card card-item">
                    <div className="card-body">
                        ...
                        <a href="#" className="btn theme-btn theme-btn-outline w-100">Request a demo <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
                {/* <!-- end card --> */}
            </div>
            ...
            <div className="col-lg-5">
                ...
                >
                    ...
                    <div className="info-body">
                        ...
                        <a href="talent.html" className="btn theme-btn">Disilab Talent <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
            </div>
            {/* <!-- end col-lg-5 --> */}
            ...
            <div className="col-lg-5">
                <div className="info-box text-center">
                    ...
                    <div className="info-body">
                        ...
                        <p className="pb-4">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that</p>
                        <a href="advertising.html" className="btn theme-btn">Disilab Advertising <i className="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
            </div>
            {/* <!-- end col-lg-5 --> */}
    ...
    <div className="container">
        <div className="row align-items-center">
            ...
            <div className="col-lg-5 text-right">
                <a href="free-demo.html" className="btn theme-btn">Create a free team <i className="la la-arrow-right icon ml-1"></i></a>
            </div>
        </div>
    </div>
    {/* <!-- end container --> */}
            ...
            <div className="modal-body">
                <form method="post">
                    ...
                    <div className="form-group d-flex align-items-center justify-content-between">
                        ...
                        <a href="javascript:void(0)" className="lost-pass-btn fs-14 hover-underline">Forgot Password?</a>
                    </div>

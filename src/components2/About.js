                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="hero-content">
                                    ...
                                    <p class="lh-26">Our asynchronous knowledge management and collaboration offering <strong class="fw-medium text-black">Forums for Teams</strong>, is transforming how people work.</p>
                                </div>
                                {/* <!-- end hero-content --> */}
                            </div>
                            {/* <!-- end col-lg-6 --> */}
                            <div class="col-lg-6">
                                <div class="generic-img-box h-100">
                                    <img class="lazy" src="/assets/images/img-loading.png" data-src="/assets/images/img1.jpg" alt="image" />
                                    <img class="lazy" src="assets/images/img-loading.png" data-src="assets/images/img2.jpg" alt="image" />
                                    <img class="lazy" src="assets/images/img-loading.png" data-src="assets/images/img3.jpg" alt="image" />
                                    <img class="lazy" src="assets/images/img-loading.png" data-src="assets/images/img4.jpg" alt="image" />
                                </div>
                            </div>
                            {/* <!-- end col-lg-6 --> */}
                        </div>
                            ...
                            <div class="col-lg-10 mx-auto">
                                <div class="award-content text-center">
                                    <p class="section-desc pb-3">Founded in 2009, Forums’s public platform is used by nearly everyone who codes to learn, share their knowledge, collaborate, and build their careers. Our products and tools help developers and technologists in life and at work. These products include
                                        <a href="#" class="text-color hover-underline">Forums for Teams</a>, <a href="#" class="text-color hover-underline">Forums Advertising</a>, and Forums for
                        ...
                        <div class="modal-body">
                            <form method="post">
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="#!void(0)" class="lost-pass-btn fs-14 hover-underline">Forgot Password?</a>
                                </div>
                                <div class="btn-box">
                                ...
                                <p class="create-account-text text-right fs-14 pt-1">
                                    New to Forums? <a class="signup-btn text-color hover-underline" href="#!void(0)">Create account</a>
                                </p>
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox fs-14">
                                        ...
                                        <label class="custom-control-label custom--control-label" htmlFor="agreeCheckBox">By signing up, you agree to our <a href="privacy-policy.html" class="text-color hover-underline">Privacy Policy.</a></label>
                                    </div>
                                </div>
                                <div class="btn-box">
                                    <button type="submit" class="btn theme-btn w-100">
                                ...
                                <p class="create-account-text text-right fs-14">
                                    Already on Forums? <a class="login-btn text-color hover-underline" href="#">Log in</a>
                                </p>
                                <div class="icon-element my-4 mx-auto shadow-sm fs-25">Or</div>
                                <div class="text-center">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post">
                                ...
                                <div class="btn-box">
                                    ...
                                    <p class="create-account-text text-right fs-14">
                                        Not a member? <a class="text-color signup-btn hover-underline" href="#!void(0)">Create account</a>
                                    </p>
                                </div>
                            </form>
                        </div>
